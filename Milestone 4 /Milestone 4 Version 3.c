...
void slow_drive(int speed)
{
            ...
            // Adjust division for less/more turning control
            		...
            		if (monitorLightShortRight() > monitorLightShortLeft() + 13){
            		motor[motor_right] = speed;
            		motor[motor_left] = -speed;
        			} else if (monitorLightShortRight() < monitorLightShortLeft() - 13){
        				motor[motor_right] = -speed;
            		motor[motor_left] = speed;
            	} else {
...
void fast_drive(int speed)
{
            // If positive right side is getting stronger readings, need to move left
            // If negative left side is getting stronger readings, need to move right
            // Adjust division for less/more turning control

            		if (monitorLightLongRight() > monitorLightLongLeft() + 13){
            		motor[motor_right] = -speed;
            		motor[motor_left] = -speed - 10;
        			} else if (monitorLightLongRight() < monitorLightLongLeft() - 13){
