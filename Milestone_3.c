...
short LONG_IR_SENSOR_THRESHOLD = 500;
short SHORT_IR_SENSOR_THRESHOLD = 1000;
...
short monitorLight(short IRsensor)
{
	...
	static short minLevelIR1 = 4096;	// Minimum light level seen by IR sensor 1
	static short maxLevelIR1 = 0;			// Maximum light level seen by IR sensor 1
	static short diffLevelIR1 = 0;		// Delta between maximum and minimum seen in last 0.1 seconds

	short lightLevel1 = SensorValue[IRsensor];
